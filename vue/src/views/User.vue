<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-input class="ml-5" style="width: 260px" placeholder="请输入邮箱" suffix-icon="el-icon-message"
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload :action="'http://'+ serverIp +':8082/user/import'" :show-file-list="false" accept="xlsx"
...
export default {
  ...
  methods: {
    ...
    exp(){
      window.open(`http://${serverIp}:8082/user/export`)
    },
